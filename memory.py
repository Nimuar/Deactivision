...
#
from minigames import print_line, show_message, clear_lcd, lcd
...
def play_pattern_sequence(pattern):
    print("\nEyes on the board!")
    show_message(lcd, "Eyes on the board!")
    
    for i in range(4, 0, -1):
        print(f"Sequence starting in {i}...")
        show_message(lcd, f"Sequence starting in {i}...")
        time.sleep(1.0)
